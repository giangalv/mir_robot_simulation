...
PUB_TOPICS = [
    ...
    #TopicConfig('tf_static', TFMessage, dict_filter=_tf_dict_filter, topic_renamed='/tf_static'), # WORKING usefull for know the real_tf_srtatic but then it is better to commentted
