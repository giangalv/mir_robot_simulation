...
public:
    PointCloudTransformer()
        : Node("pointcloud_right_transformer"),
          tf_buffer_(this->get_clock()),
          tf_listener_(tf_buffer_)
    {
        this->declare_parameter<std::string>("input_topic", "/camera_floor_right/obstacles");
        this->declare_parameter<std::string>("output_topic", "/camera_floor_right/transformed_obstacles");
